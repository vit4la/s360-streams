...
4. ОБЯЗАТЕЛЬНО придумай короткий запрос для поиска картинки на английском языке (2-5 слов, например: "tennis match WTA indoor", "tennis player portrait", "tennis court grass").

ВАЖНО: Все 4 поля обязательны! Поле image_query должно быть строкой на английском языке.
...
{ "title": "...", "body": "...", "hashtags": ["...", "..."], "image_query": "..." }"""
